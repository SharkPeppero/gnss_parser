/**
 * @brief 解析 u-blox 原始消息并转换为导航、观测和星历结果。
 */
...
private:
   ...
   * string (ref [2] 4.7) args   : unsigned char *buff I glonass navigation data
   * string bits in frame with hamming buff[ 0]: string bit 85-78 buff[ 1]:
   * string bit 77-70
   *                                  ...
  ...
  /* crc-24q parity
   * -------------------------------------------------------------- compute
   * crc-24q parity for sbas, rtcm3 args   : unsigned char *buff I data int  len
   *    I      data length (bytes) return : crc-24Q parity notes  : see
   * reference [2] A.4.3.3 Parity
   *-----------------------------------------------------------------------------*/
   ...
   * ----------------------------------------------------*/
  uint32_t getbitu2(const uint8_t *buff, const uint32_t p1, const uint32_t l1, const uint32_t p2, const uint32_t l2) const;
  int getbits2(const uint8_t *buff, const uint32_t p1, const uint32_t l1, const uint32_t p2, const uint32_t l2) const;
  /* get three component bits
   * --------------------------------------------------*/
  uint32_t getbitu3(const uint8_t *buff, const uint32_t p1, const uint32_t l1, const uint32_t p2, const uint32_t l2, const uint32_t p3, const uint32_t l3) const;
  int getbits3(const uint8_t *buff, const uint32_t p1, const uint32_t l1, const uint32_t p2, const uint32_t l2, const uint32_t p3, const uint32_t l3) const;
